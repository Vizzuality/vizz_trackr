...
class NonStaffCostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create non_staff_cost" do
    assert_difference('NonStaffCost.count') do
      post non_staff_costs_url, params: { non_staff_cost: { contract_id: @non_staff_cost.contract_id, cost: @non_staff_cost.cost, cost_type: @non_staff_cost.cost_type } }
    end
  ...
  test "should update non_staff_cost" do
    patch non_staff_cost_url(@non_staff_cost), params: { non_staff_cost: { contract_id: @non_staff_cost.contract_id, cost: @non_staff_cost.cost, cost_type: @non_staff_cost.cost_type } }
